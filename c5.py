...
ACTIONS = {
    'os': """#C5_ROOT
        sudo sh -c '
            set -e
            apt update
            apt -y install astyle nginx certbot python3-venv python3-wheel python3-dev libldap-dev libsasl2-dev python3-psutil python3-certbot-nginx npm racket zip curl rsync
            apt -y upgrade
