...
┗━━━━━━━━┹────────────────────┴────────────────────┘</pre>"""],
    ...
    ['coach_mouse_short_move'               ,  1, "Detect mouse usage to make a small position change"],
    ['coach_mouse_short_move_chars'         ,  3, " characters on the same line"],
    ['coach_mouse_short_move_drift'         ,  3, " lines on the same column"],
    ['coach_mouse_line_bounds'              ,  1, "Detect mouse usage to go to the line begin/end"],
    ['coach_retype_after_delete'            ,  1, "Detect text retyped after deletion"],
    ['coach_retype_after_delete_chars'      , 10, " characters retyped"],
    ['coach_many_horizontal_arrows'         ,  1, "Detect many ← → successive strokes"],
    ['coach_many_horizontal_arrows_count'   , 20, " successive strokes"],
    ['coach_arrow_then_backspace'           ,  1, "Detect → and then Backspace"],
    ['coach_arrow_then_backspace_count'     ,  3, " repetition of the sequence"],
    ['coach_many_vertical_arrows'           ,  1, "Detect many ↑ ↓ successive strokes"],
    ['coach_many_vertical_arrows_count'     , 50, " sucessive strokes"],
    ['coach_scroll_full_document'           ,  1, "Detect long scroll to go to document begin/end"],
